...
import { TranslateJsProps } from '@/lib/types';
...
export default function TranslateJs({ siteId, language = 'vi' }: TranslateJsProps) {
  const languageObject = {
    member_register_write_lastname: t('field_lastname_blur', language),
    member_register_write_firstname: t('field_firstname', language),
    msg_require: t('msg_require', language),
    msg_password_require: t('msg_password_require', language),
    msg_password_length: t('msg_password_length', language),
    msg_password_confirm_require: t('msg_password_confirm_require', language),
    msg_password_confirm_equal: t('msg_password_confirm_equal', language),
    msg_password_current_require: t('msg_password_current_require', language),
    msg_gender_require: t('msg_gender_require', language),
    msg_location_require: t('msg_location_require', language),
    msg_country_require: t('msg_country_require', language),
    msg_email_require: t('msg_email_require', language),
    msg_email_rule: t('msg_email_rule', language),
    msg_email_exist: t('msg_email_exist', language),
    msg_email_available: t('msg_email_available', language),
    msg_email_length: t('msg_email_length', language),
    msg_firstname_require: t('msg_firstname_require', language),
    msg_lastname_require: t('msg_lastname_require', language),
    msg_fullname_require: t('msg_fullname_require', language),
    msg_fullname_rule: t('msg_fullname_rule', language),
    msg_position_require: t('msg_position_require', language),
    msg_select_jobs: t('msg_select_jobs', language),
    msg_maxlen_ckeditor: t('msg_maxlen_ckeditor', language),
    msg_valid_salary: t('msg_valid_salary', language),
    msg_valid_expyear: t('msg_valid_expyear', language),
    msg_mobile_require: t('msg_mobile_require', language),
    msg_mobile_rule: t('msg_mobile_rule', language),
    msg_id_card: t('msg_id_card', language),
    msg_invalid_filesize: t('msg_invalid_filesize', language),
    msg_accept_file: t('msg_accept_file', language),
    msg_job_is_expired: t('msg_job_is_expired', language),
    msg_job_is_applied: t('msg_job_is_applied', language),
    msg_job_is_saved_successfully: t('msg_job_is_saved_successfully', language),
    msg_you_have_already_save_this_job: t('msg_you_have_already_save_this_job', language),
    msg_select_survey_answer: t('msg_select_survey_answer', language),
    msg_confirm_delete: t('msg_confirm_delete', language),
    msg_datebirthday_rule: t('msg_datebirthday_rule', language),
    msg_old_resume_will_be_lost: t('msg_old_resume_will_be_lost', language)
  };
  ...
  // Create script content for injection
  const scriptContent = `
    var language = ${JSON.stringify(languageObject)};
    var language_common = ${JSON.stringify(languageCommon)};
  `;
